<div class="flex">
    ...
    <aside
        {{$attributes->merge(['class'=>"max-w-64 sticky left-0 z-40 space-y-2 overflow-y-auto h-screen border-r border-main-border bg-surface px-3 pb-4 pt-2 shadow-sm ease-out"])}}>

        <div class="flex items-center gap-2">
            <button
                class="inline-flex h-10 w-10 items-center justify-center gap-1 rounded-md border text-sm hover:bg-accent hover:text-accent-text">
                <svg
                    stroke="currentColor"
                    fill="none"
                    stroke-width="2"
        ...
        <ul class="w-full list-none space-y-1 p-1">
            <a
                href="#"
                class="inline-flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-md bg-primary px-3 py-2 text-sm text-primary-text hover:bg-primary hover:text-primary-text">
                <span
            ...
            <a
                href="#"
                class="inline-flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-accent hover:text-accent-text">
                <span
                    class="flex size-5 flex-shrink-0 items-center justify-center [&>svg]:h-4 [&>svg]:w-4">
                    <svg
                        stroke="currentColor"
            ...
            <div>
                <button
                    class="group inline-flex h-10 w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-accent hover:text-accent-text">
                    <span
                        class="flex size-5 flex-shrink-0 items-center justify-center [&>svg]:h-4 [&>svg]:w-4">
                        <svg
                            stroke="currentColor"
                    ...
                    <div class="flex-1 text-left font-medium">Ecommerce</div>
                    <span>
                        <svg
                            stroke="currentColor"
                            fill="none"
            ...
            <a
                href="#"
                class="inline-flex h-10 w-full cursor-default items-center justify-center gap-2 rounded-md px-3 py-2 text-sm text-muted-text/75">
                <span
                    class="flex size-5 flex-shrink-0 items-center justify-center [&>svg]:h-4 [&>svg]:w-4">
                    <svg
                        stroke="currentColor"
                ...
                <div class="flex-1 text-left">
                    <p class="flex-1 text-sm font-medium">Location</p>
                </div>
            </a>
        </ul>
    </aside>
