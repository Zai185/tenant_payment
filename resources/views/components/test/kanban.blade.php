<div
    class="relative w-full max-w-[352px] overflow-auto rounded-2xl bg-kanban py-2">
    <!-- /* ------------------------------ Kanban Header ----------------------------- */ -->
    <div class="flex w-full items-center justify-between px-3 py-2">
        <div class="flex items-center gap-2">
            <h3 class="font-medium text-main-text sm:text-lg">Todo</h3>
            <span
    ...
    <div class="space-y-4 px-4 py-2">
        ...
        <div class="w-full cursor-pointer space-y-4 rounded-lg bg-surface p-4">
            <h5 class="w-10/12 text-sm font-medium">
            ...
            <div class="flex items-center gap-2 text-muted-text sm:gap-4">
                <div class="flex items-center gap-1">
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M12.5 7.25a.75.75 0 0 0-1.5 0v5.5c0 .27.144.518.378.651l3.5 2a.75.75 0 0 0 .744-1.302L12.5 12.315V7.25Z"></path>
                        <path
                ...
                <div class="flex w-full items-center justify-end -space-x-2">
                    ...
                    <div
                        class="!ml-1.5 flex items-center justify-center text-xs text-muted-text">
                        +3
                    </div>
                </div>
            </div>
        ...
        <div class="w-full cursor-pointer space-y-4 rounded-lg bg-surface p-4">
            ...
            <!-- Kanban Footer -->
            <div class="flex w-full items-center justify-between text-muted-text">
        ...
        <!-- /* ---------- Kanban Card ---------- */ -->
        <div
            class="relative w-full cursor-pointer space-y-4 rounded-lg bg-surface p-4">
            <h5 class="w-10/12 text-sm font-medium">Presentation Slide Design</h5>
