<div
    class="relative w-full max-w-xl overflow-auto rounded-2xl border border-main-border bg-surface">
    <table class="w-full text-left text-sm text-main-text rtl:text-right">
        ...
        <tbody>
            ...
            <tr class="bg-surface text-main-text">
                <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium">
                    Lindsay Walton
                </th>
                <td class="px-4 py-3">Feb 17, 2024</td>
...
<div
    class="custom_scroll_bar relative h-96 w-full max-w-6xl overflow-auto rounded-2xl border border-main-border bg-accent sm:h-[475px]">
    <table class="relative text-sm">
        <!-- /* ------------------------------ Table Header ------------------------------ */ -->
        <thead class="sticky left-0 top-0 z-10 h-11 border-b bg-accent">
            <tr class="border-b border-main-border text-left">
                <!-- header checkbox -->
                <th class="px-4 py-3 font-semibold">
                    <div class="inline-flex items-center gap-2">
                        <label for="check-all" class="relative flex items-center">
                            <input
                                id="check-all"
                                class="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-[4px] border border-main-text transition-all checked:border-primary checked:bg-primary indeterminate:border-primary indeterminate:bg-primary [&+span>svg]:text-primary-text"
                                type="checkbox" />
                            <span
        ...
        <tbody class="divide-border divide-y">
            <!-- ------------ Customer 1 ------------ -->
            <tr class="border-b border-main-border bg-surface text-left">
                ...
                <td class="min-w-40 px-4 py-2 align-middle">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            <p>Aaliyah Hanson</p>
                            <p class="w-40 truncate text-xs text-muted-text">
                ...
                <td class="min-w-32 px-4 py-2 align-middle">
                    <div class="text-sm">
                        <p>Feb 17, 2024</p>
                        <p class="text-xs text-muted-text">08:48 AM</p>
                    </div>
                </td>
