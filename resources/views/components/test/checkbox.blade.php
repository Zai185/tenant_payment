...
<div>
        ...
        <div class="inline-flex items-center gap-2">
            <label
                ...
                <input
                    ...
                    class="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-[4px] border border-main-text transition-all checked:border-primary checked:bg-primary indeterminate:border-primary indeterminate:bg-primary"
                    type="checkbox"
                    checked />
                <span
                    class="pointer-events-none absolute left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 opacity-0 transition-opacity peer-checked:opacity-100 peer-indeterminate:opacity-100 peer-disabled:[&>svg]:text-muted-text">
                    <svg
                        class="text-primary-text"
                        stroke="currentColor"
                        fill="none"
    ...
    <p class="text-nuetral-text pl-7 text-xs sm:text-sm">
