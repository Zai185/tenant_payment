<div>
    <div x-data="{step: @entangle('step'), package: @entangle('form.package'), payment_type: @entangle('payment_type')}" class="w-full flex">
        <div class="py-2 px-4 w-full">
            <form wire:submit.prevent="submit" class="mx-auto py-8">
                ...
                @if ($step <= count($steps))
                    ...
                    <h2 class="text-2xl font-medium my-4 text-center capitalize" x-text="('{{$steps[$step -1]['title']}}').replaceAll('_', ' ') ">
                    </h2>
                    @endif

                    <div x-show="step == 1" x-transition class="w-[448px] mx-auto">
                        <div class="grid grid-cols-2 gap-2">
                            <x-input has-error type="text" wire:model="form.first_name" placeholder="First name" label="First Name" />
                            <x-input has-error type="text" wire:model="form.last_name" placeholder="Last name" label="Last Name" />
