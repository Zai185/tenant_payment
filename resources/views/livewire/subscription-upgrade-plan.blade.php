...
<div x-data="{payment_type: @entangle('payment_type'),  payment: @entangle('payment')}">
    ...
    <div class="flex gap-4 md:flex-row flex-col md:items-start items-center">
        ...
        <div class="flex gap-4 items-start sm:items-center md:items-start flex-col sm:flex-row md:flex-col">
            <div class="relative rounded-xl border border-danger">
                <x-badge class="absolute top-4 right-4 z-10 bg-danger">Old Package</x-badge>
                <x-packages.card :package="$package" />
            </div>
            <x-icons.arrow-right class="mx-auto shrink-0 rotate-90 sm:rotate-0 md:rotate-90" />
            <div class="relative rounded-xl border border-success">
                <x-badge class="absolute top-4 right-4 z-10 bg-success">New Package</x-badge>
                <x-packages.card :package="$package" />
            </div>
        </div>
        <div class="flex-1">
